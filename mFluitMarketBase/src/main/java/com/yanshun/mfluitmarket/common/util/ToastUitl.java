...
public class ToastUitl {
    ...
    private static Toast initToast(CharSequence message, int duration) {
        if (toast == null) {
            toast = Toast.makeText(FMBaseApplication.appContext, message, duration);
        } else {
...
//		Toast.makeText(context, strResId, Toast.LENGTH_SHORT).show();
        initToast(FMBaseApplication.appContext.getResources().getText(strResId), Toast.LENGTH_SHORT).show();
    }
    ...
    public static void showLong(int strResId) {
        initToast(FMBaseApplication.appContext.getResources().getText(strResId), Toast.LENGTH_LONG).show();
    }
